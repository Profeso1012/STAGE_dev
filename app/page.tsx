  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-background to-background/50">
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative py-20 md:py-32 overflow-hidden bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url('https://cdn.builder.io/api/v1/image/assets%2Fe7d6e6588b2240528723df58a8e77493%2F9105b378f0d846f3a0e1a22d6c361c0c?format=webp')"}}>
